...
import com.martijnvdueren.connection.CommandlineConnection;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        YeeLightConnection yeeLightConnection = new YeeLightConnection(new CommandlineConnection("192.168.0.100",55443));
